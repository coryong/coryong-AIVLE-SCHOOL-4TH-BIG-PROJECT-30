...
def reset_sequence():
    with connection.cursor() as cursor:
        cursor.execute("ALTER TABLE crawling_crawling AUTO_INCREMENT = 1")
...
def save_from_csv():
    ...
    # CSV 파일 읽어오기
    df = pd.read_csv("C:\\Users\\user\\Desktop\\crwaling_merge\\KERNEL\\Crawling\\youtube_videos_1.csv", encoding='utf-8-sig')
